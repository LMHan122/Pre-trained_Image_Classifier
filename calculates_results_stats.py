...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_match'] = sum(1 for i in results_dic if results_dic[i][2] == 1)

    #number of correctly classified dog images
    results_stats_dic['n_correct_dogs'] = sum(1 for i in results_dic if results_dic[i][3] + results_dic[i][4] == 2)

    #number of correctly classified NON-dog images
    results_stats_dic['n_correct_notdogs'] = sum(1 for i in results_dic if results_dic[i][3] + results_dic[i][4] == 0)

    #number of correctly classified dog breeds
    results_stats_dic['n_correct_breed'] = sum(1 for i in results_dic if results_dic[i][2] + results_dic[i][3] == 2)
